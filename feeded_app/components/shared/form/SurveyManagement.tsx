...
import {
  ...
  Program,
  ResponseData,
} from "@/components/shared/form/useSurveyManagement";
...
const ResponseDetails: React.FC<{
  ...
  return (
    <motion.div
      ...
      className="w-full sm:w-64 p-4 space-y-4">
...
export default function SurveyManagement() {
  ...
  const handleSendSurvey = async (programId: string, type: "hot" | "cold") => {
    ...
    try {
      await (type === "hot"
        ? sendHotSurveys(programId)
        : sendColdSurveys(programId));
    } catch (error) {
      console.error(
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          size="sm"
                          className="flex items-center justify-center text-xs sm:text-sm py-1 px-2 sm:py-2 sm:px-4">
                      ...
                      <DropdownMenuTrigger asChild>
                        <Button
                          ...
                          {sendingSurvey[program.id] ? (
                            <span className="animate-spin ml-1 sm:ml-2">⏳</span>
                          ) : (
                            <SendIcon className="h-3 w-3 sm:h-4 sm:w-4 ml-1 sm:ml-2" />
                          )}
                        </Button>
                      </DropdownMenuTrigger>
                      ...
                      <DropdownMenuTrigger asChild>
                        <Button
                          ...
                          {downloadingAnswers[program.id] ? (
                            ...
                            <DownloadIcon className="h-3 w-3 sm:h-4 sm:w-4 ml-1 sm:ml-2" />
                          )}
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent align="end">
